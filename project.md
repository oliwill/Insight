...
| 每周框架复盘 | 已实现 | `scripts/weekly_review.py` |
...
| 2026-05-25 | README 承担最小安装验证入口 | 新维护者优先需要短路径确认依赖、核心评分、section 写入、symbol mapping 和 backtest parsing 可用 | 详细运维步骤继续放在 runbook，README 保留可快速复制执行的验证命令。 |
